package com.cli_ticket.ticketing_system.config;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("/chat")
                .setAllowedOrigins("http://127.0.0.1:5500", "http://localhost:4200" , "http://127.0.0.1:9090") // Allow connection from this origin
                .withSockJS();
    }
}
